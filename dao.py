#DAO vem de "Data Access Object", e é um padrão de objeto utilizado
# para isolar os códigos relacionados à lógica do banco de dados e o código da aplicação.
# o DAO realmente encapsula como acessar o banco de dados. No nosso caso isso significatodo o código SQL.
# Em um projeto mais complexo teremos várias classes de DAO, por exemplo ClienteDao,
# ProdutoDao, UsuarioDao etc. Todas essas classes definem cada persistência.
